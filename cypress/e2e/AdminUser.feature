Feature: STEP Admin parent User automation
    ...
    ###########
    # christian+post@greenwoodcampbell.com  = admin parent user
    # christian+post1@greenwoodcampbell.com = parent
    #christian+nonsouat@greenwoodcampbell.com =admin parent user
